...
const VALIDATORS = {
  employeeId: {
    ...
    msg: "2–20 characters. Letters, numbers, /, -, _ allowed",
  },
  firstName: {
    required: true,
...
export default function AdminRegister() {
  ...
  const renderStep = () => {
    switch (activeStep) {
      ...
      case 2:
        return <JobStep {...stepProps} />;
      case 3:
        return <PayrollStep {...stepProps} />;
      case 4:
  ...
  return (
    <div className="" ref={topRef}>
      ...
      {toast && (
        <div
          className={`fixed top-5 right-5 z-50 flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-xl text-sm font-medium max-w-sm ${
            toast.type === "success"
